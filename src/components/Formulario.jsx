...
const Formulario = ({agregarColaborador}) => { 
  ...
  const validarYAgregarColaborador = (e) => {
    ...
    if(nombre == "" || correo == "" || edad == "" || cargo == "" || telefono == "") {
      ...
      agregarColaborador({nombre: nombre, correo: correo, edad: edad, cargo: cargo, telefono: telefono})
  ...
  <>
    ...
    <Form onSubmit={validarYAgregarColaborador}>
      ...
      <Form.Group className="mb-3" controlId="formBasicPhone">
        <Form.Control type="number" placeholder="Telefono del colaborador" value={telefono} onChange={(e) => setTelefono(e.target.value)} />
      </Form.Group>
